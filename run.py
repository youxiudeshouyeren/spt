...
parser.add_argument('--r', type=list, default=[8,4,4], help='r')
...
args.data_path='/data/spt/Archive/'
...
train_loader = DataLoader(train_set, batch_size=args.batch_size, shuffle=True,generator=torch.Generator(device = 'cuda'))
dev_loader = DataLoader(dev_set, batch_size=args.batch_size, shuffle=True,generator=torch.Generator(device = 'cuda'))
test_loader = DataLoader(test_set, batch_size=args.batch_size, shuffle=True,generator=torch.Generator(device = 'cuda'))
